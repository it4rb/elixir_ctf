defmodule ElixirCtfWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirCtfWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirCtfWeb.Gettext, "errors", msg, opts)
    end
  end
